...
from gentities.models import Guser, Gentity
...
class Adjunto(models.Model):
    propietario = models.ForeignKey(Guser)
...
class Mensaje(models.Model):
    emisor = models.ForeignKey(Guser, related_name="emisor")
    receptores = models.ManyToManyField(Guser, related_name="receptores")
...
class Borrado(models.Model):
    eraser = models.ForeignKey(Guser)
...
class Leido(models.Model):
    lector = models.ForeignKey(Guser)
...
class Importante(models.Model):
    marcador = models.ForeignKey(Guser)
...
class Aviso(models.Model):
    usuario = models.ForeignKey(Guser)
...
class Mensaje_cola(models.Model):
    mensaje = models.ForeignKey(Mensaje, blank=True, null=True)
